  ...
  return (
    <section className={styles.Description}>
      ...
      <div className={styles.Description__text}>
        ...
        <p>
          Gikariu&apos;s: ¡Su puerta de entrada a la tecnología del mañana!
          Sumérgete en un mundo de dispositivos y equipos de última generación.
          Manténgase a la vanguardia y redefina su estilo de vida digital con
          nosotros.
        </p>
      </div>
    </section>
